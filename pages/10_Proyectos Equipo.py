...
options_equipo = st.multiselect(
    '¿Que personas quieres ver?',
    lista_equipo,
    lista_equipo)

columnas_temp = ['Tipo','Proyecto'] + options_equipo

df_proyectos_equipo = df_proyectos_equipo[(df_proyectos_equipo['Tipo'].isin(options_proyectos))][columnas_temp]
